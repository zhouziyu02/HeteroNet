...
def forecast_with_model(model, tp_to_predict, observed_data, observed_tp, observed_mask):
	if hasattr(model, "forecasting"):
		return model.forecasting(tp_to_predict, observed_data, observed_tp, observed_mask)
	return model(tp_to_predict, observed_data, observed_tp, observed_mask)
...
def compute_all_losses(model, batch_dict, dataset=None):
	...
	pred_y = forecast_with_model(model, batch_dict["tp_to_predict"],
